...
\newcommand\MatchedSumTyp[2]{#1 \blacktriangleright_{+} #2}
...
\[
  ...
  \begin{array}{l@{\quad=\quad}l@{\quad}l}
    ...
    \subst{\tau}{\alpha}{ \Tsum{C(\tau'); \shole} }
      & \Tsum{C( \subst{\tau}{\alpha}{\tau'} ); \shole} \\
    \subst{\tau}{\alpha}{ \hole{} } & \hole{} \\
    \subst{\alpha'}{\alpha}{ \hole[\alpha]{} } & \hole[\alpha']{} \\
    \subst{\alpha'}{\alpha}{ \hole[\alpha']{} } & \hole[\alpha']{} & \text{ when } \alpha \neq \alpha' \\
  \end{array}
\]
...
\Judgment{
  \MatchedSumTyp{\tau}{\Tsum{C_i(\tau_i)}_{C_i \in \TagSet}}
}{
  $\tau$ has matched sum type $\Tsum{C_i(\tau_i)}_{C_i \in \TagSet}$
}
...
\begin{mathparpagebreakable}
  ...
  \inferrule[SInj]{
    ...
    \syn{\Gamma}{ \Einj{C}{e} }{ \Tsum{C(\tau); \shole}}
  }
...
\begin{mathpar}
  ...
  \inferrule[AInjUnexpectedArg]{
    ...
    \ana{\Gamma}{ \hole[\Einj{C_j}{e}]{u} }{ \tau }
  }

  \inferrule[AInjExpectedArg]{
    \MatchedSumTyp{\tau}{ \Tsum{C_i(\tau_i)}_{C_i \in \TagSet} } \\
    C_j \in \TagSet \\
    \tau_j \neq \Unit
  }{
    \ana{\Gamma}{ \hole[\Einj{C_j}{\Unit}]{u} }{ \tau }
  }
...
\begin{mathparpagebreakable}
  ...
  \inferrule[EAInjTagErr]{
    ...
    \anaelab{\Gamma}{
      ...
      \dhole[ \cast{ \Dinj{C}{\tau''}{d} }{ \tau' }{ \hole{} } ]{\id{\Gamma}}{u}
    }{ \hole{} }{ \Delta, u :: \tau[\Gamma] }
  } 

  \inferrule[EAInjUnexpectedArg1]{
    \tau = \Tsum{C_i(\tau_i)}_{C_i \in \TagSet} \\
    C_j \in \TagSet \\
    \tau_j = \Unit \\
    e \neq \Unit \\\\
    ...
    \anaelab{\Gamma}{
      ...
      \dhole[ \Dinj{C_j}{\tau'}{ \cast{d}{\tau_j'}{\Unit} } ]{\id{\Gamma}}{u}
    }{\tau}{\Delta, u :: \tau[\Gamma]}
  }

  \inferrule[EAInjUnexpectedArg2]{
    \tau = \Tsum{C(\Unit); \shole} \\
    e \neq \Unit \\
    \anaelab{\Gamma}{e}{ \hole{} }{ d }{ \tau' }{\Delta} \\
    \tau'' = \Tsum{C(\tau'); \shole}
  }{
    \anaelab{\Gamma}{
      ...
      \dhole[ \Dinj{C}{\tau''}{ \cast{d}{\tau'}{\Unit} } ]{\id{\Gamma}}{u}
    }{\tau}{\Delta, u :: \tau[\Gamma]}
  }

  \inferrule[EAInjExpectedArg1]{
    \tau = \Tsum{C_i(\tau_i)}_{C_i \in \TagSet} \\
    C_j \in \TagSet \\
    \tau_j \neq \Unit \\
    ...
    \anaelab{\Gamma}{
      ...
      \dhole[ \Dinj{C_j}{\tau'}{ \cast{\Unit}{\Unit}{\hole{}} } ]{\id{\Gamma}}{u}
    }{\tau}{\Delta, u :: \tau[\Gamma]}
  }

  \inferrule[EAInjExpectedArg2]{
    \tau = \Tsum{C(\tau'); \shole} \\
    \tau' \neq \Unit \\
    \tau'' = \Tsum{C(\Unit); \shole}
  }{
    \anaelab{\Gamma}{
      ...
      \dhole[ \Dinj{C}{\tau''}{ \cast{\Unit}{\Unit}{\hole{}} } ]{\id{\Gamma}}{u}
    }{\tau}{\Delta, u :: \tau[\Gamma]}
  }
...
\begin{mathpar}
  ...
  % \inferrule[BVSumCast2]{
  %   \MatchedSumTyp{\tau}{ \Tsum{C_i(\tau_i)}_{C_i \in \TagSet} } \\\\
  %   \MatchedSumTyp{\tau'}{ \Tsum{C_i(\tau_i')}_{C_i \in \TagSet'} } \\\\
  %   \TagSet \neq \TagSet' \\
  %   \TagSet \cap \TagSet' = \Set{C_j} \\
  %   \tau_j \neq \tau_j' \\
  %   \boxedval{d}
  % }{
  %   \boxedval{ \cast{d}{\tau}{\tau'} }
  ...
  \inferrule[BVSumCast12]{
    \tau = \Tsum{C_i(\tau_i)}_{C_i \in \TagSet} \\\\
    \tau' = \Tsum{C_j(\tau_j); \shole} \\\\
    C_j \in \TagSet \\
    \tau_j \neq \tau_i \\
    \boxedval{d}
  }{
