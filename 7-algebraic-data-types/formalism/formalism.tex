...
\[
  \Gamma, \asc{X}{T} = \begin{cases}
    ...
    \Gamma & X = \Missing \wedge T = \Missing \\
  \end{cases}
\]
...
\[
  ...
  \begin{array}{l@{\quad=\quad}l@{\quad}l}
    ...
    \subst{\tau}{\alpha}{ \hole[\alpha_1]{u} } & \hole[ \subst{\tau}{\alpha}{\alpha_1} ]{u} \\
  \end{array}
\]
...
\begin{mathpar}
  ...
  \inferrule[TVRecVar]{
    \valid{\Theta,\alpha}{\tau}
  }{
    \valid{\Theta}{ \Trec{\alpha}{\tau} }
  }

  \inferrule[TVRecHole]{
    \valid{\Theta}{\tau}
  }{
    \valid{\Theta}{ \Trec{\hole{}}{\tau} }
  }
...
\begin{mathpar}
  ...
  \inferrule[TCRecVar]{
    \consistent{\tau_1}{ \subst{\alpha_1}{\pi_2}{\tau_2} }
  }{
    \consistent{
      \Trec{\alpha_1}{\tau_1}
    }{
...
\begin{mathpar}
  ...
  \inferrule[SLamBodyNotSyn]{
    \valid{\emptyset}{\tau} \\
    \ana{\Gamma, \asc{x}{\tau}}{e}{\hole{}}
  }{
    \syn{\Gamma}{ \hole[ \Efun{x}{\tau}{e} ]{u} }{\hole{}}
    }

  \inferrule[SLamInvalidTyp]{
    \neg\left( \valid{\emptyset}{\tau} \right) \\
    \ana{\Gamma,\asc{x}{\hole{}}}{ e }{\hole{}}
  }{
    \syn{\Gamma}{ \hole[ \Efun{x}{\tau}{e} ]{u} }{\hole{}}
  }
...
\begin{mathpar}
  ...
  \inferrule[ARollInvalidTyp]{
    \neg(\valid{\emptyset}{\tau})
  }{
    \ana{\Gamma}{ \hole[\Eroll{e}]{u} }{\tau}
  }
  ...
  \inferrule[AInjInvalidTyp]{
    C_j \in \TagSet \\
    \neg(\valid{\emptyset}{T_j}) \\
    \valid{\Gamma}{E}
  }{
