...
\begin{mathpar}
  ...
  \inferrule[AInjExpectedBody]{
    ...
    \ana{\Gamma}{ \hole[\Einj{C_j}{\None}]{u} }{\Tsum{C_i(\tau_i)}_{C_i \in \TagSet}}
  }
...
\begin{mathparpagebreakable}
  \inferrule[ESUnit]{
    ...
    \synelab{\Gamma}{\None}{\None}{\None}{\emptyset}
  }
...
\begin{mathparpagebreakable}
  ...
  \inferrule[EAInjExpectedBody]{
    ...
    C_j \in \TagSet \\
    \tau_j \neq \None \\
    \tau' = \Tsum{\Set{C_i(\tau_i)}_{C_i \in \TagSet \setminus C_j} \cup \Set{C_j(\None)}}
  }{
    \anaelab{\Gamma}{
...
\begin{mathpar}
  ...
  \inferrule[GSum]{
    \Set{\tau_i = \None \vee \tau_i = \hole{}}_{C_i \in \TagSet}
  }{
...
\begin{mathpar}
  ...
  \inferrule[MGSum]{
    ...
    \Set{
      \left( \tau_i   =  \None \implies \tau_i' = \None   \right) \wedge
      \left( \tau_i \neq \None \implies \tau_i' = \hole{} \right)
    }_{C_i \in \TagSet}
  }{
    \MatchedGroundTyp{
      \Tsum{C_i(\tau_i)}_{C_i \in \TagSet}
