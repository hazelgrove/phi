...
\[
  ...
  \begin{array}{l@{~~}c@{~~}c@{~~}l}
    ...
    % \HTagVar & X & \Coloneqq & x \mid \Absent \\
    \IHExp & d & \Coloneqq &
      x
      \mid \Dfun{x}{\tau}{d}
      \mid \Dapp{d}{d}
...
\[
  \Gamma, \asc{X}{T} = \begin{cases}
    ...
    \Gamma, \asc{x}{\hole{}} & X = x \wedge T = \Absent \\
    \Gamma & X = \Absent \\
  \end{cases}
\]
...
\begin{mathpar}
  ...
  \inferrule[AInjExpectedBody]{
    ...
    \ana{\Gamma}{ \hole[\Einj{C_j}{\Absent}]{u} }{\Tsum{C_i(T_i)}_{C_i \in \TagSet}}
  }
...
\begin{mathpar}
  ...
  \inferrule[EAInjExpectedBody]{
    ...
    C_j \in \TagSet \\
    T_j = \tau_j \\
    \tau' = \tau \uplus \Tsum{C_j(\Absent)}
  }{
    \anaelab{\Gamma}{
      \hole[ \Einj{C_j}{\Absent} ]{u}
    }{\tau}{
      \hole[ \Dinj{\tau'}{C_j}{\Absent} ]{u}_{\id{\Gamma}}
    }{\tau}{\Delta, u :: \tau[\Gamma]}
  }
...
\begin{mathpar}
  ...
  \inferrule[EAAbsent]{
    ...
    \anaelab{\Gamma}{\Absent}{\Absent}{\Absent}{\Absent}{\emptyset}
  }
\end{mathpar}
...
%     % 
%   }{
%     \assign{\Delta}{\Gamma}{\Absent}{\Absent}
%   }
% \end{mathpar}
...
\begin{mathpar}
  ...
  \inferrule[GSum]{
    \Set{T_i = \hole{} \vee T_i = \Absent}_{C_i \in \TagSet}
  }{
