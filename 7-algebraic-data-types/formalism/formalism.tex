...
\begin{mathpar}
  ...
  \inferrule[TCSum1]{
    \cardinal{\TagSet} = \cardinal{\TagSet'} \\
    \Set{ \consistent{C_i}{C_i'} }_{i < \cardinal{\TagSet}} \\
    \Set{ \consistent{\tau_i}{\tau_i'} }_{i < \cardinal{\TagSet}} 
  }{
    \consistent{
...
\Judgment{
  ...
  $\tau$ has matched finite sum type $\Tsum{C_i(\tau_i)}_{C_i \in \TagSet}$
}
...
\begin{mathparpagebreakable}
  ...
  \inferrule[EAInjExpectedArg]{
    \MatchedSumTyp{\tau}{ \Tsum{C_i(\tau_i)}_{C_i \in \TagSet} } \\
    C_j \in \TagSet \\
    \tau_j \neq \Unit \\
    \tau' = \Tsum{C_j(\Unit); \shole}
  }{
    \anaelab{\Gamma}{
