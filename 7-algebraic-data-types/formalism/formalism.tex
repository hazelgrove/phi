...
% \newcommand\newhole[2][]{\langle\langle#1\rangle\rangle_{#2}}
...
\begin{mathpar}
  ...
  \inferrule[ESAppNotArr]{
    ...
    }{ \Delta_1 \cup \Delta_2, u :: \Tarrow{ \hole{} }{ \hole{} } [\Gamma]}
  }
  ...
  \inferrule[ESInjError]{
    ...
    \synelab{\Gamma}{
      ...
      \hole[
        \Dinj{C}{ \Tsum{C(T)} }{ \cast{D}{T}{ \hole{} } }
      ]{u}_{ \id{\Gamma} }
    }{\Delta, u :: \Tsum{C(T)}[\Gamma]}
  }
...
\begin{mathpar}
  \inferrule[MGArr]{
    ...
    \MatchedGroundTyp{ \Tarrow{\tau_1}{\tau_2} }{ \Tarrow{\hole{}}{\hole{}} }
  }
...
\begin{mathpar}
  ...
  \inferrule[ITAppCast]{
    ...
    \trans{
      \Dapp{
        \cast{d_1}{ \Tarrow{\tau_1}{\tau_2} }{ \Tarrow{\tau_1'}{\tau_2'} }
      }{
        d_2
      }
    }{
...
\[
  ...
  \begin{array}{l@{~~}c@{~~}c@{~~}l}
    \EvalCtx & \E & {}\Coloneqq{} &
      ...
      \mid \Dunroll{\E}
      \mid \Dinj{C}{\tau}{\E}
      \mid \hole[\E]{u}_\sigma
      \mid \mhole[\E]{u}_\sigma
      \mid \cast{\E}{\tau}{\tau}
...
\begin{mathpar}
  ...
  \inferrule[FNEHoleInside]{
    ...
    \eval{ \hole[d]{u}_\sigma }{ \hole[\E]{u}_\sigma }{ d' }
  }
