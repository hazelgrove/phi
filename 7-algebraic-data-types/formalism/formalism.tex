...
\begin{mathpar}
  \inferrule[SRoll]{
    \syn{\Gamma}{ e }{ \subst{ \rectype{\alpha}{\tau} }{ \alpha }{ \tau }}
  }{
    \syn{\Gamma}{ \eroll{e} }{ \rectype{\alpha}{\tau} }
  }

  \inferrule[SUnroll]{
    \syn{\Gamma}{ e }{ \rectype{\alpha}{\tau} }
  }{
    \syn{\Gamma}{ \unroll{e} }{ \subst{ \rectype{\alpha}{\tau} }{ \alpha }{ \tau }}
  }
...
\begin{mathpar}
  ...
  \inferrule[AUnroll]{
    ...
    \ana{\Gamma}{ \unroll{e} }{ \subst{\rectype{\alpha}{\tau}}{\alpha}{\tau} }
  }

  \inferrule[AUnrollBadType]{
    \ana{\Gamma}{e}{\hole}
  }{
    \ana{\Gamma}{ \hole[\unroll{e}]^u }{ \subst{\rectype{\alpha}{\tau}}{\alpha}{\tau} }
  }
\end{mathpar}
%
\begin{mathpar}
