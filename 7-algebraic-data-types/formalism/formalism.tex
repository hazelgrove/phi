...
\begin{mathparpagebreakable}
  ...
  \inferrule[SInjTagErr]{
    ...
    \syn{\Gamma}{\Einj{\TagHole[\Tag]{u}}{e}}{\hole{}}
  }
...
\begin{mathpar}
  ...
  \inferrule[AInjTagErr]{
    ...
    \ana{\Gamma}{ \Einj{\TagHole[\Tag]{u}}{e} }{ \Tsum{C_i(\tau_i)}_{C_i \in \TagSet} }
  }
...
\begin{mathparpagebreakable}
  ...
  \inferrule[ESInjTagErr]{
    \anaelab{\Gamma}{e}{\hole{}}{d}{\tau}{\Delta} \\
    \tau' = \Tsum{\TagHole[\Tag]{u}(\tau)}
  }{
    \synelab{\Gamma}{
      \Einj{\TagHole[\Tag]{u}}{e}
    }{\hole{}}{
      \Dinj{\TagHole[\Tag]{u}}{\tau'}{ \cast{d}{\tau}{\hole{}} }
    }{\Delta}
  }
...
\begin{mathparpagebreakable}
  ...
  \inferrule[EAInjTagErr]{
    \Tag \notin \TagSet \\
    \anaelab{\Gamma}{e}{\hole{}}{d}{\tau}{\Delta} \\
    \tau' = \Tsum{\Set{C_i(\tau_i)}_{C_i \in \TagSet} \cup \Set{\TagHole[\Tag]{u}(\tau)}}
  }{
    \anaelab{\Gamma}{
      \Einj{\TagHole[\Tag]{u}}{e}
    }{ \Tsum{C_i(\tau_i)}_{C_i \in \TagSet} }{
