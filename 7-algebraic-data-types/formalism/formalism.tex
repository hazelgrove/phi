...
\begin{mathpar}
  ...
  \inferrule[TCSum]{
    % \Set{ \validtag{C_i} }_{C_i \in \TagSet} \\
...
\begin{mathpar}
  ...
  \inferrule[AInjTagErr]{
    ...
    \ana{\Gamma}{ \Einj{\TagHole[c]{u}}{E} }{ \Tsum{C_i(T_i)}_{C_i \in \TagSet} }
  }
...
\begin{mathparpagebreakable}
  ...
  \inferrule[ESInjNoneTagErr]{
    \tau = \Tsum{\TagHole[c]{u}(\None)}
  }{
    \synelab{\Gamma}{
      \Einj{\TagHole[c]{u}}{\None}
    }{\hole{}}{
      \Dinj{\TagHole[c]{u}}{\tau}{\None}
    }{\Delta}
  }
...
\begin{mathparpagebreakable}
  ...
  \inferrule[EAInjSomeTagErr]{
    \anaelab{\Gamma}{e}{\hole{}}{d}{\tau}{\Delta} \\
    \tau' = \Tsum{\Set{C_i(T_i)}_{C_i \in \TagSet} \cup \Set{\TagHole[c]{u}(\tau)}}
  }{
    \anaelab{\Gamma}{
      \Einj{\TagHole[c]{u}}{e}
    }{ \Tsum{C_i(T_i)}_{C_i \in \TagSet} }{
      \Dinj{\TagHole[c]{u}}{\tau'}{ \cast{d}{\tau}{\hole{}} }
    }{ \Tsum{C_i(T_i)}_{C_i \in \TagSet} }{ \Delta }
  }

  \inferrule[EAInjNoneTagErr]{
    \tau = \Tsum{\Set{C_i(T_i)}_{C_i \in \TagSet} \cup \Set{\TagHole[c]{u}(\None)}}
  }{
    \anaelab{\Gamma}{
      \Einj{\TagHole[c]{u}}{\None}
    }{ \Tsum{C_i(T_i)}_{C_i \in \TagSet} }{
      \Dinj{\TagHole[c]{u}}{\tau}{\None}
    }{ \Tsum{C_i(T_i)}_{C_i \in \TagSet} }{ \emptyset }
  }
