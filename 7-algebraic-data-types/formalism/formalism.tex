...
\begin{mathpar}
  ...
  \inferrule[TCSum12]{
    C_j \in \TagSet \implies \consistent{\tau}{\tau_j}
  }{
    \consistent{
      \Tsum{C_i(\tau_i)}_{C_i \in \TagSet}
    }{
...
\begin{mathpar}
  ...
  \inferrule[AInjTagErr]{
    ...
    \ana{\Gamma}{ \Einj{C}{e} }{ \Tsum{C_i(\tau_i)}_{C_i \in \TagSet} }
  }
...
\begin{mathpar}
  ...
  \inferrule[TAInj2]{
    ...
    \assign{\Delta}{\Gamma}{ \Dinj{C}{\tau}{d} }{ \tau }
  }
...
\begin{mathpar}
  ...
  \inferrule[BVSum2Cast]{
    \tau = \Tsum{C_1(\tau_1); \shole} \\\\
    \tau' = \Tsum{C_1'(\tau_1'); \shole} \\\\
    C_1' = C_1 \implies \consistent{\tau_1'}{\tau_1} \\
    \boxedval{d}
  }{
    \boxedval{ \cast{d}{\tau}{\tau'} }
  }

  \inferrule[BVSum12Cast]{
    \tau = \Tsum{C_i(\tau_i)}_{C_i \in \TagSet} \\
    \tau' = \Tsum{C(\tau''); \shole} \\\\
    C = C_i \implies \consistent{\tau''}{\tau_i} \\
    \boxedval{d}
  }{
    \boxedval{ \cast{d}{\tau}{\tau'} }
  }

  \inferrule[BVSum21Cast]{
    \tau = \Tsum{C(\tau''); \shole} \\
    \tau' = \Tsum{C_i(\tau_i)}_{C_i \in \TagSet} \\\\
    C_i = C \implies \consistent{\tau_i}{\tau''} \\
    \boxedval{d}
  }{
    \boxedval{ \cast{d}{\tau}{\tau'} }
  }
