...
\DeclareDocumentCommand{\HTag}{}{\mathsf{HTag}}
\DeclareDocumentCommand{\HTagT}{}{\mathsf{HTagT}}
...
\DeclareDocumentCommand{\inj}{O{C} o}{\normalfont\texttt{inj}_{#1}\left(#2\right)}
...
\[
  ...
  \begin{array}{l@{~~}c@{~~}c@{~~}ll}
    \HTyp & \tau & {}\Coloneqq{} & \ldots \mid (\rectype) \mid \typevar \mid \sumtype{C_i}{T_i}{C_i \in \C} \\
    \HTagT & T & {}\Coloneqq{} & \tau \mid \varnothing \\
    \HExp & e    & {}\Coloneqq{} & \ldots \mid \roll{e} \mid \unroll{\tau}{e} \mid \inj{x} \mid \casexp{e}{C_i}{x_i}{e_i}{C_i \in \C} \\
