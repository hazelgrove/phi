...
\begin{figure}
  ...
  \begin{mathpar}
    % \judgment{
      % \hasTypeCtx{\CtxVar}{\HoleCtxVar}{\SortImmVar}{\TMk{(\TCFun{\TMk{\SortTypConVar}{\SortNCompleteVar}}{\SortTypVar})}{\SortNCompleteVar'}} \\
      % \hasTypeCtx{\CtxVar}{\HoleCtxVar}{\SortImmVar'}{\TMk{\SortTypConVar}{\SortNCompleteVar}}
    % }{
      % \hasTypeCtx{\CtxVar}{\HoleCtxVar}{\EAp{\SortImmVar}{\SortImmVar'}}{\TMk{\TCPair{\SortTypConVar}{\SortTypConVar'}}{\SortNCompleteVar}}
    % }{TAAp}
  \end{mathpar} \\
  %
  Wrapping:
