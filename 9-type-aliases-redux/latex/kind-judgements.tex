...
\subsection*{}
    \begin{minipage}{\textwidth}
        ...
        \begin{mathpar}
            \inferrule{ }{\KindWellFormed[\Type]}
            \and
            \inferrule{ }{\KindWellFormed[\KHole]}
            \and
            \inferrule{\WellFormedAtKind{\typ}}{\KindWellFormed[\SKind]}
            \and
            \inferrule{\KindWellFormed[{\knd[1]}] \\ \KindWellFormed[{\knd[2]}]}{\KindWellFormed[\DepFunKind]}
        \end{mathpar}
    \end{minipage}
\end{document}
