...
\subsection*{}
    \begin{minipage}{\textwidth}
        ...
        \begin{mathpar}
            ...
            \and
            \inferrule{\KindEquiv{}{} \\ \TypeEquivAtKind[\HoleCtx\TypVarCtx[],\typvar\KndAssump\knd[1]]{\typ[1]}{\typ[2]}}{\TypeEquivAtKind{\TypeFun[][\knd[1]][\typ[1]]}{\TypeFun[][\knd[2]][\typ[2]]}[\DepFunKind[][\knd[1]][\knd]]}
            \and
            ...
            \\
            \inferrule{\WellFormedAtKind{\typ[1]}[\SKind[\knd][\typ[2]]] \\ \WellFormedAtKind{\typ[2]}}{\TypeEquivAtKind{\typ[1]}{\typ[2]}[\SKind[\knd][\typ[2]]]}
            \\
...
\subsection*{}
    \begin{minipage}{\textwidth}
        ...
        \begin{mathpar}
            ...
            \and
            \mprset{myfraction=\inferruledotfrac}
            \inferrule{\WellFormedAtKind{\typ}}{\TypeEquiv{\typ}{\typ}}
            \and
            \inferrule{\TypeEquiv{\typ[2]}{\typ[1]}}{\TypeEquiv{\typ[1]}{\typ[2]}}
            \and
            \inferrule{\TypeEquiv{\typ[1]}{\typ[3]} \\ \TypeEquiv{\typ[3]}{\typ[2]}}{\TypeEquiv{\typ[1]}{\typ[2]}}
        \end{mathpar}
    \end{minipage}
\subsection*{}
    \begin{minipage}{\textwidth}
...
\subsection*{}
    \begin{minipage}{\textwidth}
        ...
        \begin{mathpar}
            ...
            \and
            \inferrule{ }{\MatchedPiKind{\DepFunKind}}
            \and
            \inferrule{\KindEquiv{\knd}{\DepFunKind}}{\MatchedPiKind{\SKind[\knd][\typ]}[\DepFunKind[][\knd[1]][\SKind[\knd[2]][\TypeAp[\typ][\typvar]]]]}
        \end{mathpar}
    \end{minipage}
\subsection*{}
    \begin{minipage}{\textwidth}
