    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                ...
                \and
                \rule[EquivAK\hyph\Pi]{\WellFormedAtKind{\typ[1]}[\DepFunKind[][\knd[1]][\knd[3]]] \\ \WellFormedAtKind{\typ[2]}[\DepFunKind[][\knd[1]][\knd[4]]] \\ \TypeEquivAtKind[\HoleCtx\xTypVarCtx,\typvar\KndAssump\knd[1]]{\TypeAp[\typ[1]][\typvar]}{\TypeAp[\typ[2]][\typvar]}[\knd[2]]}{\TypeEquivAtKind{\typ[1]}{\typ[2]}[\DepFunKind]}
                \and
    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                ...
                \and
                \rule[CWF\hyph TypVar]{\typvar\notin\dom{\TypVarCtx[]} \\ \KindWellFormed}{\ContextWellFormed[\HoleCtx\xTypVarCtx[],\typvar\KndAssump\knd]}
                \and
                \rule[CWF\hyph Hole]{\hole\notin\dom{\HoleCtx[]} \\ \KindWellFormed}{\ContextWellFormed[\xHoleCtx[],\hole\KndAssump\knd;\TypVarCtx[]]}
            \end{mathpar}
        \end{minipage}
\section{Metatheory}
    \subsection*{}
    ...
    \begin{proof}
        ...
        \begin{tabular*}{\textwidth}{lc@{\extracolsep{\fill}}ll}
            Weakening.
                &PK-$\lambda$& $\ContextWellFormed[\HoleCtx\ExtendTypVarCtx[][L][\knd[2]]]$ & by IH \\
                & & $\ContextWellFormed[\HoleCtx\ExtendTypVarCtx[][][\knd[1]]]$ & by COK on premiss \\
                && $\KindWellFormed[\knd[1]]$ & by premiss \\
                && $\KindWellFormed[\knd[1]][\HoleCtx\ExtendTypVarCtx[][L][\knd[L]]]$ & by Weakening on premiss \\
                && $\ContextWellFormed[\HoleCtx\TypVarCtx[],\typvar[L]\KndAssump\knd[L],\typvar\KndAssump\knd[1]]$ & \\
                && $\PrincipalKind[\HoleCtx\TypVarCtx[],\typvar\KndAssump\knd[1],\typvar[L]\KndAssump\knd[L]]{\typ}[\knd[2]]$ & \\
                && $\PrincipalKind[\HoleCtx\TypVarCtx[],\typvar[L]\KndAssump\knd[L],\typvar\KndAssump\knd[1]]{\typ}[\knd[2]]$ & \\
            OK-PK.
