    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            *Variables implicitly assumed to be fresh as necessary* \\
            (eg $\typvar[L]$ is fresh in $\mathcal{J}$ in Weakening)
        \end{minipage}
\section{Metatheory}
    \subsection*{}
    ...
    \begin{proof}
        ...
        \begin{tabular*}{\textwidth}{lc@{\extracolsep{\fill}}ll}
            Weakening.
                ...
                & & $\ContextWellFormed[\HoleCtx\ExtendTypVarCtx[][][\knd[1]]]$ & by OK-PK on premiss \\
                & & $\KindWellFormed[\knd[1]]$ & by CWF-TypVar \\
                & & $\KindWellFormed[\knd[1]][\HoleCtx\ExtendTypVarCtx[][L][\knd[L]]]$ & by Weakening \\
                & & $\PrincipalKind[\HoleCtx\TypVarCtx[],\typvar\KndAssump\knd[1]]{\typ}[\knd[2]]$ & by premiss \\
            OK-PK.
