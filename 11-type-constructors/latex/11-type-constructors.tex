...
% get rid of 10-modules stuff
    ...
    \RenewDocumentCommand{\InTypVarCtx}{ooO{\knd}}{\TypVarCtx[][1],\typvar[#2]\KndAssump{#3},\TypVarCtx[][2]}
    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                ...
                \and
                \rule{\KindWellFormed[{\knd[1]}] \\ \PrincipalKind[\HoleCtx\ExtendTypVarCtx[][][{\knd[1]}]]{\typ}[\knd[2]]}{\PrincipalKind{\TypeFun[][\knd[1]]}[\SKind[\DepFunKind][\TypeFun[][\knd[1]]]]}
                \and
