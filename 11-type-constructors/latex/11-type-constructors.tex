...
\section{Algorithm}
    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                \rinfer[]{\AlgNatKind[in=\bse, out=\Type]}{
                }
                \and
                \rinfer[]{\AlgNatKind[in=\typvar, out=\knd]}{
                    \InTypVarCtx[]
                }
                \and
                \rinfer[]{\AlgNatKind[in=\binop, out=\Type]}{
                }
                \and
                \rinfer[]{\AlgNatKind[in=\ETypeHole, out=\knd]}{
                    \InTypHoleCtx[]
                }
                \and
                \rinfer[]{\AlgNatKind[in=\NETypeHole, out=\knd]}{
                    \InTypHoleCtx[]
                }
                \and
                \rinfer[]{\AlgNatKind[in=\TypeAp, out=\subst{\typ[2]}{\typvar}{\knd[2]}]}{
                    \AlgNatKind[in=\typ[1]] \\
    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            \judgbox{\AlgWHReduc[in=\EvalCtx{\typ[1]}, out=\EvalCtx{\typ[2]}]}{
                $\EvalCtx{\typ[1]}$ single step weak head reduces to $\EvalCtx{\typ[2]}$
            }
            \begin{mathpar}
                \rinfer[]{\AlgWHReduc[in=\EvalCtx{\TypeAp[(\TypeFun)][\typ[1]]}, out=\EvalCtx{\subst{\typ[1]}{\typvar}{\typ}}]}{
                    TODO:~check~\typ[1]~against~\knd
                }
                \and
                \rinfer[]{\AlgWHReduc[in=\EvalCtx{\typvar}, out=\EvalCtx{\typ}]}{
                    \AlgNatKind[in=\typvar, out=\SKind]
                }
                \and
                \rinfer[]{\AlgWHReduc*[in=\bse, out=\bse]}{
                }
                \and
                \rinfer[]{\AlgWHReduc*[in=\binop, out=\binop]}{
                }
                \and
                \rinfer[]{\AlgWHReduc*[in=\EvalCtx{\ETypeHole}, out=\EvalCtx{\ETypeHole}]}{
                }
                \and
                \rinfer[]{\AlgWHReduc*[in=\EvalCtx{\NETypeHole}, out=\EvalCtx{\NETypeHole}]}{
                }
                \and
                \rinfer[]{\AlgWHReduc*[in=\EvalCtx{\UnboundTypeVar}, out=\EvalCtx{\UnboundTypeVar}]}{
                }
                \and
                \rinfer[]{\AlgWHReduc*[in=\TypeFun, out=\TypeFun]}{
                }
            \end{mathpar}
        \end{minipage}
    \subsection*{}
    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                ...
                \and
                \rinfer[]{\AlgTypeNormal[out=\TypeFun[1][\knd[\omega_1]][\typ[\omega]]]}{
                    \AlgKindNormal[out=\DepFunKind[][\knd[\omega_1]][\knd[\omega_2]]] \\
                    \AlgTypeNormal[ctx=\HoleCtx\ExtendTypVarCtx[][1][\knd[\omega_1]], in=\TypeAp[\tau][\typvar[1]], kind=\subst{\typvar[1]}{\typvar}{\knd[2]}]
                }
            \end{mathpar}
        \end{minipage}
    \subsection*{}
    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                \rinfer[]{\AlgPathNormal[in=\bse, out=\bse, kind=\Type]}{
                }
                \and
                \rinfer[]{\AlgPathNormal[in=\typvar, out=\typvar]}{
                    \InTypVarCtx[]
                }
                \and
                \rinfer[]{\AlgPathNormal[in=\binop, out=\binop[\typ[\omega_1]][\typ[\omega_2]], kind=\Type]}{
                    \AlgTypeNormal[in=\typ[1], kind=\Type, out=\typ[\omega_1]] \\
                    \AlgTypeNormal[in=\typ[2], kind=\Type, out=\typ[\omega_2]]
                }
                \and
                \rinfer[]{\AlgPathNormal[in=\ETypeHole, out=\ETypeHole]}{
                    \InTypHoleCtx[]
                }
                \and
                \rinfer[]{\AlgPathNormal[in=\NETypeHole, out=\NETypeHole]}{
                    \InTypHoleCtx[]
                }
                \and
                \rinfer[]{\AlgPathNormal[in=\TypeAp, out=\TypeAp[\typ[\omega_1]][\typ[\omega_2]], kind=\subst{\typ[\omega_2]}{\typvar}{\knd[2]}]}{
