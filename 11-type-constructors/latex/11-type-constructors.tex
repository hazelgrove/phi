...
\section{Algorithm}
    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                \rinfer[]{\AlgWHReduc[in=\ElimCtx{\TypeAp[(\TypeFun)][\typ[1]]}, out=\ElimCtx{\subst{\typ[1]}{\typvar}{\typ}}]}{
                    TODO:~check~\typ[1]~against~\knd
                }
                \and
                \rinfer[]{\AlgWHReduc[in=\ElimCtx{\typvar}, out=\ElimCtx{\typ}]}{
                ...
                \and
                \rinfer[]{\AlgWHReduc*[in=\ElimCtx{\ETypeHole}, out=\ElimCtx{\ETypeHole}]}{
                }
                \and
                \rinfer[]{\AlgWHReduc*[in=\ElimCtx{\NETypeHole}, out=\ElimCtx{\NETypeHole}]}{
                }
                \and
                \rinfer[]{\AlgWHReduc*[in=\ElimCtx{\UnboundTypeVar}, out=\ElimCtx{\UnboundTypeVar}]}{
                }
                \and
