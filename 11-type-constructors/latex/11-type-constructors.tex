    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                ...
                \and
                \rrule{\AlgWHReduc[in=\ElimCtx{\typvar}, out=\ElimCtx{\typ}]}{
                    \AlgNatKind[in=\typvar, out=\SKind]
                }
                \and
                \rrule{\AlgWHReduc*[in=\bse, out=\bse]}{
                }
                \and
                \rrule{\AlgWHReduc*[in=\binop, out=\binop]}{
                }
                \and
                \rrule{\AlgWHReduc*[in=\ElimCtx{\ETypeHole}, out=\ElimCtx{\ETypeHole}]}{
                }
                \and
                \rrule{\AlgWHReduc*[in=\ElimCtx{\NETypeHole}, out=\ElimCtx{\NETypeHole}]}{
                }
                \and
                \rrule{\AlgWHReduc*[in=\ElimCtx{\UnboundTypeVar}, out=\ElimCtx{\UnboundTypeVar}]}{
                }
                \and
                \rrule{\AlgWHReduc*[in=\TypeFun, out=\TypeFun]}{
                }
            \end{mathpar}
        \end{minipage}
    \subsection*{}
