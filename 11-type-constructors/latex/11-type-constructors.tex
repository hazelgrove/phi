...
\section{Metatheory}
    ...
    \begin{lemma}[Weakening]
        ...
        If $\PrincipalKind{\typ}$ and $\ContextWellFormed[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]$, then $\PrincipalKind[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]{\typ}$

        If $\PrincipalKind{\typ}$ and $\ContextWellFormed[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]$, then $\PrincipalKind[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]{\typ}$

        If $\WellFormedAtKind{\typ}$ and $\ContextWellFormed[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]$, then $\WellFormedAtKind[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]{\typ}$

        If $\WellFormedAtKind{\typ}$ and $\ContextWellFormed[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]$, then $\WellFormedAtKind[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]{\typ}$

        If $\MatchedPiKind{\knd}$ and $\ContextWellFormed[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]$, then $\MatchedPiKind[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]{\knd}$

        If $\MatchedPiKind{\knd}$ and $\ContextWellFormed[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]$, then $\MatchedPiKind[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]{\knd}$

        If $\KindEquiv{\knd[1]}{\knd[2]}$ and $\ContextWellFormed[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]$, then $\KindEquiv[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]{\knd[1]}{\knd[2]}$

        If $\KindEquiv{\knd[1]}{\knd[2]}$ and $\ContextWellFormed[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]$, then $\KindEquiv[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]{\knd[1]}{\knd[2]}$

        If $\ConsistentSubKind{\knd[1]}{\knd[2]}$ and $\ContextWellFormed[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]$, then $\ConsistentSubKind[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]{\knd[1]}{\knd[2]}$

        If $\ConsistentSubKind{\knd[1]}{\knd[2]}$ and $\ContextWellFormed[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]$, then $\ConsistentSubKind[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]{\knd[1]}{\knd[2]}$

        If $\TypeEquivAtKind{\typ[1]}{\typ[2]}$ and $\ContextWellFormed[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]$, then $\TypeEquivAtKind[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]{\typ[1]}{\typ[2]}$

        If $\TypeEquivAtKind{\typ[1]}{\typ[2]}$ and $\ContextWellFormed[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]$, then $\TypeEquivAtKind[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]{\typ[1]}{\typ[2]}$
        
        If $\KindWellFormed$ and $\ContextWellFormed[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]$, then $\KindWellFormed[\ExtendTypHoleCtx[;][][\knd[L]]\TypVarCtx[]]$

        If $\KindWellFormed$ and $\ContextWellFormed[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]$, then $\KindWellFormed[\HoleCtx\ExtendTypVarCtx[][][\knd[L]]]$
    \end{lemma}
    \begin{proof}
