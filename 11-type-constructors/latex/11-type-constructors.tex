...
% (will give actual names sometime)
    ...
    \newcommand*{\hyph}{\text{-}}
    \newcommand*{\rule}[1][(\thecounter)\refstepcounter{counter}]{\inferrule*[vcenter,rightstyle=\texttt,right=$\mathtt{#1}$]}
...
\section{Declaratives}
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                \rule[PK-Base]{\ContextWellFormed}{\PrincipalKind{\bse}[\SKind[\Type][\bse]]}
                \and
                \rule[PK-Var]{\ContextWellFormed[\HoleCtx\InTypVarCtx]}{\PrincipalKind{\typvar}[\SKind[\knd][\typvar]]}
                \and
                \rule[PK-$\oplus$]{\WellFormedAtKind{\typ[1]}[\Type] \\ \WellFormedAtKind{\typ[2]}[\Type]}{\PrincipalKind{\binop}[\SKind[\Type][\binop]]}
                \and
                \rule[PK-EHole]{\ContextWellFormed[\InTypHoleCtx\TypVarCtx]}{\PrincipalKind{\ETypeHole}[\SKind[\knd][\ETypeHole]]}
                \and
                \rule[PK-NEHole]{\ContextWellFormed[\InTypHoleCtx\TypVarCtx] \\ \WellFormedAtKind{\typ}[\knd[1]]}{\PrincipalKind{\NETypeHole}[\SKind[\knd][\NETypeHole]]}
                \and
                \rule[PK-Unbound]{\ContextWellFormed[\InTypHoleCtx\TypVarCtx] \\ \typvar\notin\dom{\TypVarCtx[]}}{\PrincipalKind{\UnboundTypeVar}[\SKind[\knd][\UnboundTypeVar]]}
                \and
                \rule[PK-$\lambda$]{\PrincipalKind[\HoleCtx\ExtendTypVarCtx[][][{\knd[1]}]]{\typ}[\knd[2]]}{\PrincipalKind{\TypeFun[][\knd[1]]}[\SKind[\DepFunKind][\TypeFun[][\knd[1]]]]}
                \and
                \rule[PK-Ap]{\PrincipalKind{\typ[1]} \\ \MatchedPiKind{\knd} \\ \WellFormedAtKind{\typ[2]}[\knd[1]]}{\PrincipalKind{\TypeAp}[\subst{\typ[2]}{\typvar}{\knd[2]}]}
            \end{mathpar}
        \end{minipage}
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                \rule[WFaK-1]{\PrincipalKind{\typ}[\SKind[\knd][\typ]]}{\WellFormedAtKind{\typ}}
                \and
                \rule[WFaK-Subsump]{\PrincipalKind{\typ}[\knd[1]] \\ \ConsistentSubKind{\knd[1]}{\knd}}{\WellFormedAtKind{\typ}}
                \\
                \mprset{myfraction=\inferruledotfrac}
                \rule[WFaK-Reit]{\PrincipalKind{\typ}}{\WellFormedAtKind{\typ}}
                \and
                \rule[WFaK-Self]{\WellFormedAtKind{\typ}}{\WellFormedAtKind{\typ}[\SKind[\knd][\typ]]}
                \and
                \rule[WFaK-$\Pi$CSKTrans]{\WellFormedAtKind{\typ}[\DepFunKind[][\knd[3]][\knd[4]]] \\ \ConsistentSubKind{\DepFunKind[][\knd[3]][\knd[4]]}{\DepFunKind}}{\WellFormedAtKind{\typ}[\DepFunKind]}
                \and
                \rule[WFaK-Flatten]{\WellFormedAtKind{\typ}[\SKind[\knd][\typ[1]]] \\ \WellFormedAtKind{\typ[1]}}{\WellFormedAtKind{\typ}}
            \end{mathpar}
        \end{minipage}
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                \rule[$\MatchedPiKindOp$-KHole]{\ContextWellFormed}{\MatchedPiKind{\KHole}[\DepFunKind[][\KHole][\KHole]]}
                \and
                \rule[$\MatchedPiKindOp$-SKHole]{\KindEquiv{\knd}{\SKind[\KHole]}}{\MatchedPiKind{\knd}[\DepFunKind[][\SKind[\KHole]][\SKind[\KHole][\TypeAp[\typ][\typvar]]]]}
                \and
                \rule[$\MatchedPiKindOp$-$\Pi$]{\KindEquiv{\knd}{\DepFunKind}}{\MatchedPiKind{\knd}}
            \end{mathpar}
        \end{minipage}
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                \rule[KEquiv-Refl]{\KindWellFormed}{\KindEquiv{\knd}{\knd}}
                \and
                \rule[KEquiv-Symm]{\KindEquiv{\knd[2]}{\knd[1]}}{\KindEquiv{\knd[1]}{\knd[2]}}
                \and
                \rule[KEquiv-Trans]{\KindEquiv{\knd[1]}{\knd[3]} \\ \KindEquiv{\knd[3]}{\knd[2]}}{\KindEquiv{\knd[1]}{\knd[2]}}
                \\
                \rule[KEquiv-$\mathtt{SKind_{SKind}}$]{\WellFormedAtKind{\typ}[\SKind[\knd][\typ[1]]]}{\KindEquiv{\SKind[\SKind[\knd][\typ[1]]][\typ]}{\SKind[\knd][\typ[1]]}}
                \and
                \rule[KEquiv-$\mathtt{SKind_{\Pi}}$]{\WellFormedAtKind{\typ}[\DepFunKind]}{\KindEquiv{\SKind[\DepFunKind][\typ]}{\DepFunKind[1][\knd[1]][\SKind[\subst{\typvar[1]}{\typvar}{\knd[2]}][\TypeAp[\typ][\typvar[1]]]]}}
                \and
                \rule[KEquiv-$\Pi$]{\KindEquiv{\knd[1]}{\knd[2]} \\ \KindEquiv[\HoleCtx\TypVarCtx[],\typvar\KndAssump\knd[1]]{\knd[3]}{\knd[4]}}{\KindEquiv{\DepFunKind[][\knd[1]][\knd[2]]}{\DepFunKind[][\knd[3]][\knd[4]]}}
                \and
                \rule[KEquiv-SKind]{\TypeEquivAtKind{\typ[1]}{\typ[2]}[\knd[1]] \\ \KindEquiv{\knd[1]}{\knd[2]}}{\KindEquiv{\SKind[\knd[1]][\typ[1]]}{\SKind[\knd[2]][\typ[2]]}}
            \end{mathpar}
        \end{minipage}
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                \rule[CSK-KHoleL]{\KindWellFormed}{\ConsistentSubKind{\KHole}{\knd}}
                \and
                \rule[CSK-KHoleR]{\KindWellFormed}{\ConsistentSubKind{\knd}{\KHole}}
                \and
                \rule[CSK-$\mathtt{SKind_{KHole}}$L]{\KindWellFormed[{\SKind[\KHole]}] \\ \KindWellFormed}{\ConsistentSubKind{\SKind[\KHole]}{\knd}}
                \and
