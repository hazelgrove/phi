...
\section{Declaratives}
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                \rule{ }{\PrincipalKind{\bse}[\SKind[\Type][\bse]]}
                \and
                \rule{\typvar\KndAssump\knd\in\TypVarCtx[]}{\PrincipalKind{\typvar}[\SKind[\knd][\typvar]]}
                \and
                \rule{\WellFormedAtKind{\typ[1]}[\Type] \\ \WellFormedAtKind{\typ[2]}[\Type]}{\PrincipalKind{\binop}[\SKind[\Type][\binop]]}
                \and
                \rule{\hole\KndAssump\knd\in\HoleCtx[]}{\PrincipalKind{\ETypeHole}[\SKind[\knd][\ETypeHole]]}
                \and
                \rule{\hole\KndAssump\knd\in\HoleCtx[] \\ \WellFormedAtKind{\typ}[\knd[1]]}{\PrincipalKind{\NETypeHole}[\SKind[\knd][\NETypeHole]]}
                \and
                \rule{\hole\KndAssump\knd\in\HoleCtx[] \\ \typvar\notin\dom{\TypVarCtx[]}}{\PrincipalKind{\UnboundTypeVar}[\SKind[\knd][\UnboundTypeVar]]}
                \and
    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                ...
                \and
                \rule{\WellFormedAtKind{\typ}[\SKind[\knd][\typ[1]]]}{\WellFormedAtKind{\typ}}
                \\
    ...
    \subsection*{}
        \begin{minipage}{\textwidth}
            ...
            \begin{mathpar}
                \rule{ }{\KindWellFormed[\Type]}
                \and
                \rule{ }{\KindWellFormed[\KHole]}
                \and
...
\section{Metatheory}
    \subsection*{}
    Contexts implicitly assumed to be wellformed in the usual way.
    \begin{definition}[size of kinds a la Stone]
        \vphantom{.}
        \begin{longtable}{LCL}
            size(\Type) &=& 1 \\
            size(\KHole) &=& 1 \\
            size(\SKind) &=& size(\knd) + 2 \\
            size(\DepFunKind) &=& size(\knd[1]) + size(\knd[2]) + 2 \\
        \end{longtable}
    \end{definition}
    \begin{lemma}
