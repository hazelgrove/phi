...
\begin{tikzpicture}[
    ...
    \draw[-{Implies}, double]([shift={(-0.1, 0)}]sig.north)--([shift={(-0.1, 0)}]temp.south);
    \draw[-{Implies}, double]([shift={(0.1, 0)}]temp.south)--([shift={(0.1, 0)}]sig.north);
    ...
    \begin{mathpar}
        ...
        \inferrule[SynElabLetModAnn]{
            ...
            \AnaElab{\Gamma;\Phi;\Xi}{\umod}{\sig}
                {\mod}{\Delta_2} \\
            \SynElab{\Gamma;\Phi;\Xi, \modvar\SigAssump\sig}{\uexp}{\typ}
                {\exp}{\Delta_3} \\
        }
        ...
        {\SynElab{\Gamma;\Phi;\Xi}{\uModTermPrj{\umod}{\lab}}{\typ}
            {\ModTermPrj{\mod}{\lab}}{\Delta}}
    \end{mathpar}
\end{minipage}
\begin{minipage}{\textwidth}
...
\end{minipage}
\begin{minipage}{\textwidth}
    \judgbox{\SynElab{\Gamma;\Phi;\Xi}{\umod}{\sig}{\mod}{\Delta}}{$\umod$ synthesizes signature $\sig$ and elaborates to $\mod$ with hole context $\Delta$}
    \begin{mathpar}
        ...
        \inferrule[SynElabConsStruct]{
            \SynElab{\Gamma;\Phi;\Xi}{\usbnd}{\sdec}
                {\sbnd}{\Delta_1} \\
            \SynElab{\Gamma, \val{\sdec};\Phi, \type{\sdec};\Xi, \submodule{\sdec}}{\Struct{\usbnds}}{\Sig{\sdecs}}
                {\Struct{\sbnds}}{\Delta_2} \\
        }
        ...
        {\SynElab{\Gamma;\Phi;\Xi}{\ModHole^u}{\SigHole}
            {\ModHole^u}{u\SigAssump\SigHole}}
        \and
        \inferrule[SynElabNonemptyModHole]{
        }
        {\SynElab{\Gamma;\Phi;\Xi}{\ModHole[\umodvar]^u}{\SigHole}
            {\ModHole[\modvar]^u}{u\SigAssump\SigHole}}
        \and
