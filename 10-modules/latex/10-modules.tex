...
\newcommand*{\SSigKind}[2][]{\orangett{SSigKind(#2)#1}}
...
\newcommand{\ConsistentSubSigKind}[3]{\mathrm{#1 \vdash #2 \lesssim #3}}
...
\begin{minipage}{\textwidth}
    ...
    \begin{mathpar}
        ...
        {\ConsistentSubSigKind{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\SSigKind[_1]{\sig[_1]}}{\SSigKind[_2]{\sig[_2]}}}
        \and
        \inferrule[nameMe]{
        }
