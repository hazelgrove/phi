...
\renewcommand*{\hole}[1]{\mathsf{submodule(}#1\mathsf{)}}
...
\newcommand{\WellFormedSig}[2]{#1 \vdash #2~\textsf{Ok}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{minipage}{\textwidth}
    ...
    \begin{mathpar}
        \inferrule[nameMe]{
        \exists\sdec[_x]\in\sdecs[_1]~st~\ConsistentSubSigKind{}{\SSigKind{\Sig{\sdec[_x]}}}{\SSigKind{\Sig{\sdec[_2]}}} \\
        \ConsistentSubSigKind{\HoleCtx;\TypVarCtx, \type{\sdec[_2]};\ModVarCtx, \submodule{\sdec[_2]};\SigVarCtx}{\Sig{\sdecs[_1]}}{\Sig{\sdecs[_2]}} \\
        }
    {\ConsistentSubSigKind{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\SSigKind{\Sig{\sdec[_{11}], \sdec[_{12}], \sdecs[_{13}]~as~\sdecs[_1]}}}{\SSigKind{\Sig{\sdec[_2], \sdecs[_2]}}}}
        ...
        {\ConsistentSubSigKind{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\SSigKind{\Sig{\TransparentTypeSdec{\lab}{\typ}}}}{\SSigKind{\Sig{\OpaqueTypeSdec{\lab}}}}}
        \and
        \inferrule[singleType2]{
            \TypeEquiv{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\typ[_1]}{\typ[_2]} \\
        }
        {\ConsistentSubSigKind{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\SSigKind{\Sig{\TransparentTypeSdec{\lab}{\typ[_1]}}}}{\SSigKind{\Sig{\TransparentTypeSdec{\lab}{\typ[_2]}}}}}
        \and
        \inferrule[singleType3]{
        }
        {\ConsistentSubSigKind{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\SSigKind{\Sig{\OpaqueTypeSdec{\lab}}}}{\SSigKind{\Sig{\OpaqueTypeSdec{\lab}}}}}
        \and
        \inferrule[singleVa]{
            \TypeEquiv{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\typ[_1]}{\typ[_2]} \\
        }
        {\ConsistentSubSigKind{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\SSigKind{\Sig{\ValSdec{\lab}{\typ[_1]}}}}{\SSigKind{\Sig{\ValSdec{\lab}{\typ[_2]}}}}}
        \and
        \inferrule[singleMod]{
            \Ana{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\sig[_1]}{\SSigKind{\sig[_2]}} \\
        }
        {\ConsistentSubSigKind{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\SSigKind{\Sig{\ModSdec{\lab}{\sig[_1]}}}}{\SSigKind{\Sig{\ModSdec{\lab}{\sig[_2]}}}}}
        \and
        \inferrule[nil]{
        }
...
\begin{minipage}{\textwidth}
    ...
    \begin{mathpar}
        ...
        {\Syn{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\SigHole^u}{\sigknd}}
        \and
        \inferrule[SynSigKndSigHole]{
            u\SigKndAssump\sigknd\in\HoleCtx \\
            \Syn{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\sigvar}{\sigknd[_1]} \\
        }
        {\Syn{\HoleCtx;\TypVarCtx;\ModVarCtx;\SigVarCtx}{\SigHole[\sigvar]^u}{\sigknd}}
    \end{mathpar}
\end{minipage}
\begin{minipage}{\textwidth}
...
\begin{minipage}{\textwidth}
    ...
    \begin{mathpar}
        ...
        {\SynElab{\TypVarCtx;\ModVarCtx;\SigVarCtx}{\SigHole^u}{\SigKHole}
            {\SigHole^u}{u\SigKndAssump\SigKHole}}
       \and
